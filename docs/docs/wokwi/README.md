...
- ESP32 DevKit
- Simulated battery-cell voltage inputs
- I2C 16x2 LCD
- LEDs
- Buzzer
- Relay
...
The Wokwi simulations are used to test:
...
Wokwi simulation links for the individual internship tasks will be
added here.
...
| Task 5 | Blynk Telemetry | https://wokwi.com/projects/474346657169552385 |
| Task 6 | Blynk Analytics | https://wokwi.com/projects/474710084518382593 |
